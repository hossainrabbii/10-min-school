...
const StickyNav = ({ currentLang }: { currentLang: string }) => {
  return (
    <div className="h-[75px] flex items-center sticky top-0 z-50 border-b bg-white md:h-[65px]">
      <div className="container mx-auto flex gap-5">
        ...
        {/* search box */}
        <div className="border rounded-full overflow-hidden p-2 text-sm flex gap-2 items-center flex-1">
          <svg
        ...
        <div className="flex items-center gap-5">
          {/* <button className="flex items-center border px-2 py-1 rounded-md hover:bg-gray-100">
            <svg
