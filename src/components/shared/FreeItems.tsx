      ...
      <div className="container">
        <div id="free_items">
          <div className="mb-14">
            ...
            <div className="relative w-full overflow-hidden bg-no-repeat bg-cover  rounded-lg bg-[url(https://cdn.10minuteschool.com/images/banner_background_1731401239364.png)]">
              <div className="p-4 absolute w-full h-full filter [&amp;&gt;*]:row-[1] [&amp;&gt;*]:col-[1]">
